...
- The browser restores its durable turn audit, session path, latest coaching, and authoritative P&L attribution after refresh, but it has no charting or offline replay export.
